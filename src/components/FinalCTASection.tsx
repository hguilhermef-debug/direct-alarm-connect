      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 bg-stat-accent/20 border border-stat-accent/40 rounded-full px-5 py-2 mb-8"
          >
            <Shield className="w-5 h-5 text-stat-accent" />
            <span className="text-stat-accent font-semibold">Não deixe para depois</span>
          </motion.div>
